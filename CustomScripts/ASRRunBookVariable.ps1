...
New-AzureRmAutomationVariable -Name "BCDRIaaSPlan" -ResourceGroupName "BCDRAzureAutomation" -AutomationAccountName $AutomationAccountName -Value $RPDetails -Encrypted $false
